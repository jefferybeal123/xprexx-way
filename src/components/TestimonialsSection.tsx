              ...
              <div className="md:col-span-2 relative z-10">
                ...
                <div className="flex justify-end gap-2">
                  <button 
                    ...
                    className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center hover:bg-kargon-red hover:text-white hover:border-kargon-red transition-colors"
                  >
                    <ChevronLeft size={20} />
                  </button>
                  <button 
